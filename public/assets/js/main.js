...
if (fileSection) {
    ...
    modalFileRecentForm.setAttribute('action', '/www/stage/plateforme_partage/app/views/files/traitement/move_file_recent.php');
    ...
    modalForm.setAttribute('action', '/www/stage/plateforme_partage/app/views/files/traitement/rename.php');
    modalFilesForm.setAttribute('action', '/www/stage/plateforme_partage/app/views/files/traitement/rename_file.php');
    ...
    modalFormFolder.setAttribute('action', '/www/stage/plateforme_partage/app/views/files/traitement/rename_folder.php');
...
if (fileMoveBtn) {
    ...
    window.addEventListener('click', (e) => {
        if (!e.target.className.includes('files-move-js')) {
            for (let i = 0; i < filesListItem.length; i++) {
                filesListItem[i].classList.add('display-none-action-list');
            }
        };
    ...
    modalFileForm.setAttribute('action', '/www/stage/plateforme_partage/app/views/files/traitement/move_file.php');
...
if (folderRemoveBtn) {
    ...
    modalFolderForm.setAttribute('action', '/www/stage/plateforme_partage/app/views/files/traitement/move_folder.php');
...
if (suggestion) {
    document.addEventListener('DOMContentLoaded', e => {
        searchInputMobile.addEventListener('keyup', e => {
            ...
            if (query != '') {
                fetch('/www/stage/plateforme_partage/app/views/home/traitement/search.php', {
                    method: 'POST',
                    headers: {
