...
<section class="comptes">
    ...
    ?>
    <form action="/www/stage/plateforme_partage/app/views/accounts/traitement/modify.php" class="comptes__form" method="POST">
            ...
            <tbody id="table-body">
                ...
                foreach ($data as $keys => $values) {
                    for ($i = 0; $i < count($values); $i++) {
                        ...
                        echo '</select>';
                        if ($values[$i]['superadmin'] != '1') {
                            echo '<a href="/www/stage/plateforme_partage/public/account/delete/' . $values[$i]['id_user'] . '" class="btn--delete compte__link">Supprimer</a>';
                        }
                        echo '</td>';
                        echo '</tr>';
                    }
