<main>
    <section class="header">
        ...
        <form action="/www/stage/plateforme_partage/app/views/files/traitement/search.php" method="POST" class="header__form">
        ...
        <div class="profile">
            <img src="/www/stage/plateforme_partage/public/assets/image/avatar/avatar_1.jpg" alt="Avatar" width="40" height="40" class="profile__image">
            ...
            <ul class="profile__list">
                ...
                <li class="profile__item">
                    <a href="/www/stage/plateforme_partage/public/profile/index/" class="profile__item--settings tooltip">
                ...
                <li class="profile__item">
                    <a href="/www/stage/plateforme_partage/app/views/home/connexion/deconnexion.php" class="profile__item--disconnect tooltip">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15">
