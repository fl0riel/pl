...
<nav class="nav">
    <div class="nav-container">
        <a href="/www/stage/plateforme_partage/public/home/index" class="nav__logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1531.26 447.1">
        ...
        <div class="nav__btns">
            ...
            <form action="/www/stage/plateforme_partage/app/views/files/traitement/search.php" method="POST" class="nav__form-search display-none-search" id="form_toggle">
        ...
        <ul class="nav__list display-none-menu" id="menu_toggle">
            ...
            if ($_SESSION['user']['role'] == 'admin') {
                ...
                <a href="/www/stage/plateforme_partage/public/file/index" class="btn btn--primary nav__link nav__link--upload">
            ...
            ?>
            <li class="nav__item">
                <a href="/www/stage/plateforme_partage/public/home/index" class="nav__link<?php if ($active === "home") {
            ...
            <li class=" nav__item">
                <a href="/www/stage/plateforme_partage/public/profile/index" class="nav__link<?php if ($active === "profile") {
                                                                                                    echo ' nav__link--active';
            ...
            <li class="nav__item nav__item--logout">
                <a href="/www/stage/plateforme_partage/app/views/home/connexion/deconnexion.php" class="nav__link"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15">
