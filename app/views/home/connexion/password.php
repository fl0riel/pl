<body class="login">
    <form action="/www/stage/plateforme_partage/app/views/home/traitement/password.php" method="POST" class="login__form">
        ...
        <fieldset>
            ...
            <div class="login-forgot-container">
                <a href="/www/stage/plateforme_partage/public/home/forgot/" class="login__link--forgot">Mot de passe oublié ?</a>
