...
<section class="profil">
    ...
    <form action="/www/stage/plateforme_partage/app/views/profile/traitement/profile.php" method="POST" class="profil__form">
        ...
        <div class="profil-container">
            ...
            <input type="text" name="email" id="email" placeholder="Mail" class="profil__input" value="<?= $_SESSION['user']['email'] ?>" pattern="^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z]{2,5})$" maxlength="145" required>
        </div>
        <div class="profil-container">
