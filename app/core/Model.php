...
class Model
{
    ...
    {
        header('Location: /www/stage/plateforme_partage/public/' . $method);
        exit;
    }
     ...
     * 
     * @return array|false Retourne un tableau associatif contenant les données des fichiers récents ou false si une erreur s'est produite.
     */
