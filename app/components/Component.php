...
<a href="/www/stage/plateforme_partage/public/account/index" class="nav__link';
        if ($active === "account") {
...
<a href="/www/stage/plateforme_partage/public/logs/index" class="nav__link';
        if ($active === "logs") {
            echo ' nav__link--active';
        }
    ...
    public static function fileTable()
    {
        ...
        <table class="files__table">
            <thead>
                <tr>
                    <td class="files__cell">Nom</td>
                    <td class="files__cell files__cell--mobile">Date</td>
                    <td class="files__cell files__cell--desktop">Type</td>
                    <td class="files__cell files__cell--desktop">Taille</td>
                    <td class="files__cell files__cell--desktop" colspan="2">Dernière modification</td>
                    <td class="toggle-display"></td>
                </tr>
            </thead>
            <tbody>';
    }
    ...
    public static function fileTableItem(array $array)
    {
        ...
        $path = $array['path'];
        $path = '/www/stage/plateforme_partage/' . substr($path, 3);
        $size = $array['size'];
        ...
        if ($_SESSION['user']['role'] == 'admin') {
            ...
            echo '</li>
                <li class="file-action__item">
                    <a href="/www/stage/plateforme_partage/public/file/delete/' . $id . '" class="file-action__link link--delete">Supprimer</a>
                </li>';
        }
        echo '</ul>
        </td>
    ...
    public static function categories()
    {
        ...
        echo '<li class="categories__item categories__item--desktop display-none">
                <a href="/www/stage/plateforme_partage/public/home/show/" class="categories__link">
            ...
            <li class="categories__item">
                <a href="/www/stage/plateforme_partage/public/home/show/1" class="categories__link">
                    <div class="categories__block">
            ...
            <li class="categories__item">
                <a href="/www/stage/plateforme_partage/public/home/show/2" class="categories__link">
                    <div class="categories__block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="55" fill="none">
                            <path d="M47.95 22.505v25.298c0 1.654-.662 3.24-1.839 4.409a6.3 6.3 0 0 1-4.44 1.826H12.368a6.3 6.3 0 0 1-4.44-1.826c-1.178-1.169-1.839-2.755-1.839-4.409V6.235c0-1.654.662-3.24 1.839-4.409A6.3 6.3 0 0 1 12.368 0h12.918a4.2 4.2 0 0 1 2.959 1.217l18.479 18.35c.785.779 1.225 1.836 1.226 2.938z" fill="#eaeae4" />
            ...
            <li class="categories__item">
                <a href="/www/stage/plateforme_partage/public/home/show/3" class="categories__link">
                    <div class="categories__block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="55" fill="none">
                            <path d="M47.95 22.505v25.298c0 1.654-.662 3.24-1.839 4.409a6.3 6.3 0 0 1-4.44 1.826H12.368a6.3 6.3 0 0 1-4.44-1.826c-1.178-1.169-1.839-2.755-1.839-4.409V6.235c0-1.654.662-3.24 1.839-4.409A6.3 6.3 0 0 1 12.368 0h12.918a4.2 4.2 0 0 1 2.959 1.217l18.479 18.35c.785.779 1.225 1.836 1.226 2.938z" fill="#eaeae4" />
                            <path d="M26.639.761v15.623c0 1.105.439 2.164 1.22 2.946s1.841 1.22 2.946 1.22h15.623" fill="#babab9" />
            ...
            <li class="categories__item">
                <a href="/www/stage/plateforme_partage/public/home/show/4" class="categories__link">
                    <div class="categories__block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="55" fill="none">
                            <path d="M47.95 22.505v25.298c0 1.654-.662 3.24-1.839 4.409a6.3 6.3 0 0 1-4.44 1.826H12.368a6.3 6.3 0 0 1-4.44-1.826c-1.178-1.169-1.839-2.755-1.839-4.409V6.235c0-1.654.662-3.24 1.839-4.409A6.3 6.3 0 0 1 12.368 0h12.918a4.2 4.2 0 0 1 2.959 1.217l18.479 18.35c.785.779 1.225 1.836 1.226 2.938z" fill="#eaeae4" />
                            <path d="M26.639.761v15.623c0 1.105.439 2.164 1.22 2.946s1.841 1.22 2.946 1.22h15.623" fill="#babab9" />
        ...
        if ($_SESSION['user']['role'] == 'admin') {
            echo '        <form action="/www/stage/plateforme_partage/app/views/files/traitement/create_folder.php" class="add-folder__form toggle-display" method="POST">
    ...
    public static function generateFilesList($array, $parent = null)
    {
        ...
        <li class="folder-action__item">
            <a href="/www/stage/plateforme_partage/public/file/deleteFolder/' . $delete . '" class="folder-action__link link--delete">Supprimer</a>
        </li>
    </ul></div>';
                ...
                if (in_array($x, $image)) {
                    $html .= '<li class="files-js"><div class="file-button-wrapper"><span class="filename__icon filename__icon--images"></span><a href="/www/stage/plateforme_partage/public/file/download/' . $key . '" data-path-file="' . $key . '" class="btn-files-js" download>' . $value . '</a><button class="' . $menu . '"  type="button"></button><ul class="files-action__list display-none-action-list">
                    ...
                    <li class="files-action__item">
                    <a href="/www/stage/plateforme_partage/public/file/deleteFile/' . $delete . '" class="files-action__link link--delete">Supprimer</a>
                    </li>
                    </ul></div>';
                }
                if (in_array($x, $pdf)) {
                    $html .= '<li class="files-js"><div class="file-button-wrapper"><span class="filename__icon filename__icon--pdf"></span><a href="/www/stage/plateforme_partage/public/file/download/' . $key . '" data-path-file="' . $key . '" class="btn-files-js" download>' . $value . '</a><button class="' . $menu . '"  type="button"></button><ul class="files-action__list display-none-action-list">
                    <li class="files-action__item">
                        <button type="button" class="files-action__link link-rename-file" id="' . $key . '">Renommer</button>
                    </li>
                    <li class="files-action__item">
                ...
                if (in_array($x, $word)) {
                    $html .= '<li class="files-js"><div class="file-button-wrapper"><span class="filename__icon filename__icon--word"></span><a href="/www/stage/plateforme_partage/public/file/download/' . $key . '" data-path-file="' . $key . '" class="btn-files-js" download>' . $value . '</a><button class="' . $menu . '"  type="button"></button><ul class="files-action__list display-none-action-list">
                    <li class="files-action__item">
                        <button type="button" class="files-action__link link-rename-file" id="' . $key . '">Renommer</button>
                    </li>
                    <li class="files-action__item">
                ...
                if (in_array($x, $excel)) {
                    $html .= '<li class="files-js"><div class="file-button-wrapper"><span class="filename__icon filename__icon--excel"></span><a href="/www/stage/plateforme_partage/public/file/download/' . $key . '" data-path-file="' . $key . '" class="btn-files-js" download>' . $value . '</a><button class="' . $menu . '"  type="button"></button><ul class="files-action__list display-none-action-list">
                    <li class="files-action__item">
                        <button type="button" class="files-action__link link-rename-file" id="' . $key . '">Renommer</button>
                    </li>
                    <li class="files-action__item">
    ...
    public static function uploadForm()
    {
        ...
        <form action="/www/stage/plateforme_partage/app/views/files/traitement/upload.php" class="upload__form" method="POST" enctype="multipart/form-data">
