...
class testValidator extends Verification
{
    function testMailRegex()
    {
        ...
        $invalidEmails = ['@example.com', 'john.doe@', 'john.doe@ex&ample.com', 'john.doe@example', 'john.doe@example.', 'john.doe@example..com', 'john.doe@exampe.com'];
        ...
        echo "Tous les tests ont été exécutés.<br>";
    }

    function testPasswordRegex()
    {
        $validPasswords = ['Asbjtr0$', 'nrqfe3_E', 'Dycsjj8/', 'sngSpt1*'];
